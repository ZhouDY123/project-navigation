...
<aside class="sidebar"><a class="brand" href="admin.php"><span class="brand-logo"><img src="assets/sanqi-logo-cropped.png" alt="三奇 3Q"></span><div>三奇.项目导航<small>SANQI PROJECT NAVIGATION</small></div></a><nav><a href="categories.php">▤ 分类管理</a><a href="admin.php">▦ 项目管理</a><a class="active" href="password.php">◇ 修改密码</a><a href="index.php">↗ 浏览前台</a><form action="logout.php" method="post"><input type="hidden" name="csrf_token" value="<?= htmlspecialchars(csrf_token(), ENT_QUOTES) ?>"><button type="submit">⇥ 退出登录</button></form></nav><div class="db-state"><i></i><div>安全会话已启用<small>管理员身份已验证</small></div></div></aside>
